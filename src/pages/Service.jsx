...
<p className="text-center text-muted mb-5">
  Smart, Scalable, and Custom-Built for Your Business Growth
        ...
        <div className="row g-4">
          {services.slice(0, 3).map((service, idx) => (
            <div className="col-md-6 col-lg-4 " key={idx} data-aos="fade-up">
              <div className="p-4 border rounded shadow h-100 bg-white text-center">
        ...
        <div className="text-center mt-5" data-aos="zoom-in">
          <button onClick={()=>nav("/enquiry")} className=" btn btncolor btn1 fw-bold mt-1">Let’s Collaborate</button>
        </div>
      </div>
    </section>
  );
